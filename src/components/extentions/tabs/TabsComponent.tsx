          ...
          <div className="flex flex-1">
            {tabItems.map((_: any, index: number) => (
              <button
                ...
                className={`flex-1 px-4 py-2 text-sm font-medium border-b-2 border-r border-gray-200 dark:border-r-[#2d2d2d] transition-colors relative cursor-pointer ${
                  activeTab === index
                    ? "border-blue-500 border-r-gray-200 dark:border-r-[#2d2d2d] text-blue-600 dark:text-blue-400 bg-white dark:bg-[#13171F]"
                    : "border-transparent border-r-gray-200 dark:border-r-[#2d2d2d] text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 hover:border-gray-300"
